        ...
        self.state = load_model(
            {
                ...
                "d4_features": self.config.get("model.d4_features", None),
                ...
                "design": self.config.get("model.design", None),
                "d_model": self.config.get("model.d_model", None),
                "num_heads": self.config.get("model.num_heads", None),
                "num_pool_heads": self.config.get("model.num_pool_heads", None),
                "num_self_attn_layers": self.config.get("model.num_self_attn_layers", None),
                "ffn_dim": self.config.get("model.ffn_dim", None),
