...
def main():
    ...
    parser.add_argument('--learning_rate', type=float, default=1e-3, help="Intial learning rate for the learning rate schedular")
    ...
    train_images, train_labels = generate_dataset(args.samples, args.psf_sigma, exp=args.exp, seed=args.seed)
    ...
    state, train_loss, val_loss = train_model(
                                    ...
                                    lr=args.learning_rate, weight_decay=args.weight_decay #optimizer details
                                )
