...
def plot_residuals_v1(
    ...
    if combined:
        ...
        plt.hist(
            ...
            color="blue",
            edgecolor="black",
            label="Combined Residuals",
        )
        if mcal:
            plt.hist(
                residuals_combined_ngmix,
                bins=30,
                alpha=0.5,
                color="orange",
                edgecolor="black",
                label="Combined Residuals (NGmix)",
            )
    ...
    if mcal:
        ...
        plt.hist(
            residuals_e1_ngmix[mask_e1_ngmix],
            bins=30,
            alpha=0.5,
            color="orange",
            edgecolor="black",
            label="Residuals e1 (NGmix)",
        )
    ...
    if mcal:
        ...
        plt.hist(
            residuals_e2_ngmix[mask_e2_ngmix],
            bins=30,
            alpha=0.5,
            color="purple",
            edgecolor="black",
            label="Residuals g2 (NGmix)",
        )
    ...
    plt.hist(
        ...
        color="teal",
        edgecolor="black",
        label="Residuals sigma (ShearNet)",
    )
    if mcal:
        plt.hist(
            residuals_sigma_ngmix,
            bins=30,
            alpha=0.5,
            color="cyan",
            edgecolor="black",
            label="Residuals sigma (NGmix)",
        )
    ...
    plt.figure(figsize=(8, 6))
    plt.hist(
        residuals_flux, bins=30, alpha=0.7, color="brown", edgecolor="black", label="Residuals flux"
    )
    if mcal:
        plt.hist(
            residuals_flux_ngmix,
            bins=30,
            alpha=0.5,
            color="tan",
            edgecolor="black",
            label="Residuals flux (NGmix)",
        )
...
def plot_psf_systematics_from_eval(
    ...
    if len(predicted_labels) != len(test_obs):
        print("Warning: Length mismatch detected!")
        print(f"  predicted_labels: {len(predicted_labels)}")
        print(f"  test_obs: {len(test_obs)}")
        print("  Trimming test_obs to match predicted_labels length...")
    ...
    if ngmix_preds is not None:
        ...
        if len(ngmix_preds_np) != len(test_obs):
            print("Warning: NGmix predictions length mismatch!")
