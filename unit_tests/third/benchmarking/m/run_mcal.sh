...
#SBATCH --output=/home/adfield/ShearNet/unit_tests/third/benchmarking/m/logs/mcal_%j.out
#SBATCH --error=/home/adfield/ShearNet/unit_tests/third/benchmarking/m/logs/mcal_%j.err
#SBATCH -p short
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python /home/adfield/ShearNet/shear_bias/m/main.py -c /home/adfield/ShearNet/unit_tests/third/benchmarking/m/config.yaml
